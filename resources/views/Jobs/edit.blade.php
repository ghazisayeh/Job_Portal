                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('jobs.update', $job->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="j_active" type="text" class="form-control @error('j_active') is-invalid @enderror" name="j_active" value="{{ old('j_active') ?? $job->j_active }}" required autocomplete="j_active">
